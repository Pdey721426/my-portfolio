    ...
    <Section  id="identity" className="py-16 ">
      <div >
        ...
        <p className="text-gray-400 max-w-2xl mb-8">
          I’m a  web developer with a strong academic foundation in
          computer applications. I completed my BCA and MCA from  <span className="underline"><a href="https://www.brainwareuniversity.ac.in/" target="_blank">Brainware University </a></span>
